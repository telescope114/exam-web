<template>
    <div class="get-exam-score" v-loading="loadingScore" element-loading-background="rgba(255, 255, 255, 1)" element-loading-text="拼命加载中..." element-loading-spinner="el-icon-loading">
        <div v-if="loadingScore" class="not-join-exam">
            <el-card></el-card>
        </div>
        <div v-else>
            <div v-if="isJoinExam" class="join-exam">
                ...
                <el-card style="width: 80%">
                    <div slot="header">
                        <h1 style="text-align: left"><span :style="questionInfo.myAnswer===questionInfo.answer?'color: #288f5d;':'color: #ed4646;'">({{questionInfo.score}}分)</span>第{{questionFirst + 1}}题：{{questionInfo.title}}</h1>
                    </div>
                    <div>
